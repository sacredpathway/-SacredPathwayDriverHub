...
//    2. "Sign in / Cloud Sync"       → AppMode = .cloud  → LoginView path
//
//  Wording per spec:
//    • "Free Local Mode"
                ...
                VStack(spacing: 32) {
                    ...
                    modeCard(
                        ...
                        bullets: [
                            ...
                            "Subscription features unlocked by your plan",
                        ],
...
You can upgrade to Cloud Sync later — your local data will be uploaded to your account when you do.
"""
            )
        }
    }
