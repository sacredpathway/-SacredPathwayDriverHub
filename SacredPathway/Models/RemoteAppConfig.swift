...
struct RemoteAppConfig: Codable, Equatable {
    ...
    /// Remote kill switch for the dispatcher↔driver Messages UI. DEFAULT OFF:
    /// treat `nil`/missing/malformed as `false` at every call site. Accepts
    /// `dispatcher_messages_enabled` (snake) or `dispatcherMessagesEnabled` (camel).
    var dispatcherMessagesEnabled: Bool?

    /// Remote kill switch for the Driver Connections feature (Dispatchers tab).
    /// DEFAULT OFF: treat nil/missing/malformed as false at every call site.
    /// Accepts `connections_enabled` (snake) or `connectionsEnabled` (camel).
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case updateMessage
        case appStoreURL
        case dispatcherMessagesEnabled
    ...
    private enum SnakeKeys: String, CodingKey {
        ...
        case app_store_url
        case update_url
        case dispatcher_messages_enabled
        case connections_enabled
    }
    ...
    init(
        ...
        dispatcherMessagesEnabled: Bool? = nil,
        connectionsEnabled: Bool? = nil
    ) {
        ...
        self.dispatcherMessagesEnabled = dispatcherMessagesEnabled
    ...
    init(from decoder: Decoder) throws {
        ...
        // Default OFF: any decode miss leaves this nil → treated as false at call sites.
        self.dispatcherMessagesEnabled =
            (try? camel?.decodeIfPresent(Bool.self, forKey: .dispatcherMessagesEnabled))
            ?? (try? snake?.decodeIfPresent(Bool.self, forKey: .dispatcher_messages_enabled))

        // Default OFF: any decode miss leaves this nil → treated as false at call sites.
        self.connectionsEnabled =
            (try? camel?.decodeIfPresent(Bool.self, forKey: .connectionsEnabled))
            ?? (try? snake?.decodeIfPresent(Bool.self, forKey: .connections_enabled))
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encodeIfPresent(dispatcherMessagesEnabled, forKey: .dispatcherMessagesEnabled)
        try c.encodeIfPresent(connectionsEnabled, forKey: .connectionsEnabled)
    }
